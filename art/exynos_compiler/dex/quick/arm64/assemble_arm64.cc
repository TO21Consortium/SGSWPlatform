...
const A64EncodingMap Arm64Mir2Lir::EncodingMap[kA64Last] = {
    ...
    ENCODING_MAP(kA64SimdDup64QX,  NO_VARIANTS(0x4e080c00),
                 kFmtSimdSd, 4, 0, kFmtRegX, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "dup", "!0v.2d, !1x", kFixupNone),
    ENCODING_MAP(kA64SimdDup32QR,  NO_VARIANTS(0x4e040c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "dup", "!0v.4s, !1r", kFixupNone),
    ENCODING_MAP(kA64SimdDup16QR,  NO_VARIANTS(0x4e020c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "dup", "!0v.8h, !1r", kFixupNone),
    ENCODING_MAP(kA64SimdDup8QR,  NO_VARIANTS(0x4e010c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "dup", "!0v.16b, !1r", kFixupNone),
    ENCODING_MAP(kA64SimdDup32DR,  NO_VARIANTS(0x0e040c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "dup", "!0v.2s, !1r", kFixupNone),
    ENCODING_MAP(kA64SimdDup16DR,  NO_VARIANTS(0x0e020c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "dup", "!0v.4h, !1r", kFixupNone),
    ENCODING_MAP(kA64SimdDup8DR,  NO_VARIANTS(0x0e010c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "dup", "!0v.8b, !1r", kFixupNone),
    ENCODING_MAP(kA64SimdVdup32QD0, NO_VARIANTS(0x4e040400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "dup", "!0v.4s, !1v.S[0]", kFixupNone),
    ENCODING_MAP(kA64SimdVdup32QD1, NO_VARIANTS(0x4e0c0400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "dup", "!0v.4s, !1v.S[1]", kFixupNone),
    ENCODING_MAP(kA64SimdVmov64QI, NO_VARIANTS(0x6f00e400),
                 kFmtSimdSd, 4, 0, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0,
                 "movi", "!0v.2d, !1d", kFixupNone),
    ENCODING_MAP(kA64SimdVmov32QI, NO_VARIANTS(0x4f000400),
                 kFmtSimdSd, 4, 0, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0,
                 "movi", "!0v.4s, !1d", kFixupNone),
    ENCODING_MAP(kA64SimdVmov16QI, NO_VARIANTS(0x4f008400),
                 kFmtSimdSd, 4, 0, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0,
                 "movi", "!0v.8h, !1d", kFixupNone),
    ENCODING_MAP(kA64SimdVmov8QI, NO_VARIANTS(0x4f00e400),
                 kFmtSimdSd, 4, 0, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0,
                 "movi", "!0v.16b, !1d", kFixupNone),
    ENCODING_MAP(kA64SimdVmov32DI, NO_VARIANTS(0x0f000400),
                 kFmtSimdSd, 4, 0, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0,
                 "movi", "!0v.2s, !1d", kFixupNone),
    ENCODING_MAP(kA64SimdVmov16DI, NO_VARIANTS(0x0f008400),
                 kFmtSimdSd, 4, 0, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0,
                 "movi", "!0v.4h, !1d", kFixupNone),
    ENCODING_MAP(kA64SimdVmov8DI, NO_VARIANTS(0x0f00e400),
                 kFmtSimdSd, 4, 0, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0,
                 "movi", "!0v.8b, !1d", kFixupNone),
    ENCODING_MAP(kA64SimdVmovQQ, NO_VARIANTS(0x4ea01c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP | REG_DEF0_USE12,
                 "orr", "!0v.16b, !1v.16b, !2v.16b", kFixupNone),
    ENCODING_MAP(kA64SimdVmovDD, NO_VARIANTS(0x0ea01c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP | REG_DEF0_USE12,
                 "orr", "!0v.8b, !1v.8b, !2v.8b", kFixupNone),
    ENCODING_MAP(kA64SimdVmovF64DD, NO_VARIANTS(0x1e604000),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "fmov", "!0S, !1S", kFixupNone),
    ENCODING_MAP(kA64SimdVmovF32SS, NO_VARIANTS(0x1e204000),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "fmov", "!0s, !1s", kFixupNone),
    ENCODING_MAP(kA64SimdMovD0X, NO_VARIANTS(0x4e081c00),
                 kFmtSimdSd, 4, 0, kFmtRegX, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.D[0], !1x", kFixupNone),
    ENCODING_MAP(kA64SimdMovD1X, NO_VARIANTS(0x4e181c00),
                 kFmtSimdSd, 4, 0, kFmtRegX, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.D[1], !1x", kFixupNone),
    ENCODING_MAP(kA64SimdMovS0W, NO_VARIANTS(0x4e041c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.S[0], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovS1W, NO_VARIANTS(0x4e0c1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.S[1], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovS2W, NO_VARIANTS(0x4e141c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.S[2], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovS3W, NO_VARIANTS(0x4e1c1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.S[3], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovH0W, NO_VARIANTS(0x4e021c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.H[0], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovH1W, NO_VARIANTS(0x4e061c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.H[1], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovH2W, NO_VARIANTS(0x4e0a1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.H[2], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovH3W, NO_VARIANTS(0x4e0e1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.H[3], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovH4W, NO_VARIANTS(0x4e121c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.H[4], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovH5W, NO_VARIANTS(0x4e161c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.H[5], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovH6W, NO_VARIANTS(0x4e1a1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.H[6], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovH7W, NO_VARIANTS(0x4e1e1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.H[7], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB0W, NO_VARIANTS(0x4e011c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[0], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB1W, NO_VARIANTS(0x4e031c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[1], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB2W, NO_VARIANTS(0x4e051c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[2], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB3W, NO_VARIANTS(0x4e071c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[3], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB4W, NO_VARIANTS(0x4e091c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[4], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB5W, NO_VARIANTS(0x4e0b1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[5], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB6W, NO_VARIANTS(0x4e0d1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[6], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB7W, NO_VARIANTS(0x4e0f1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[7], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB8W, NO_VARIANTS(0x4e111c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[8], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB9W, NO_VARIANTS(0x4e131c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[9], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB10W, NO_VARIANTS(0x4e151c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[10], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB11W, NO_VARIANTS(0x4e171c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[11], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB12W, NO_VARIANTS(0x4e191c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[12], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB13W, NO_VARIANTS(0x4e1b1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[13], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB14W, NO_VARIANTS(0x4e1d1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[14], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovB15W, NO_VARIANTS(0x4e1f1c00),
                 kFmtSimdSd, 4, 0, kFmtRegR, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0v.B[15], !1r", kFixupNone),
    ENCODING_MAP(kA64SimdMovXD0, NO_VARIANTS(0x4e083c00),
                 kFmtRegX, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0x, !1v.D[0]", kFixupNone),
    ENCODING_MAP(kA64SimdMovXD1, NO_VARIANTS(0x4e183c00),
                 kFmtRegX, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0x, !1v.D[1]", kFixupNone),
    ENCODING_MAP(kA64SimdMovWS0, NO_VARIANTS(0x0e043c00),
                 kFmtRegR, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0r, !1v.S[0]", kFixupNone),
    ENCODING_MAP(kA64SimdMovWS1, NO_VARIANTS(0x0e0c3c00),
                 kFmtRegR, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0r, !1v.S[1]", kFixupNone),
    ENCODING_MAP(kA64SimdMovDD0, NO_VARIANTS(0x5e080400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0S, !1v.D[0]", kFixupNone),
    ENCODING_MAP(kA64SimdMovDD1, NO_VARIANTS(0x5e180400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0S, !1v.D[1]", kFixupNone),
    ENCODING_MAP(kA64SimdMovSS0, NO_VARIANTS(0x5e040400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0s, !1v.S[0]", kFixupNone),
    ENCODING_MAP(kA64SimdMovSS1, NO_VARIANTS(0x5e0c0400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0s, !1v.S[1]", kFixupNone),
    ENCODING_MAP(kA64SimdMovSS2, NO_VARIANTS(0x5e140400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0s, !1v.S[2]", kFixupNone),
    ENCODING_MAP(kA64SimdMovSS3, NO_VARIANTS(0x5e1c0400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "mov", "!0s, !1v.S[3]", kFixupNone),
    ENCODING_MAP(kA64SimdSmovWB0, NO_VARIANTS(0x0e012c00),
                 kFmtRegR, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "smov", "!0r, !1v.B[0]", kFixupNone),
    ENCODING_MAP(kA64SimdSmovWH0, NO_VARIANTS(0x0e022c00),
                 kFmtRegR, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "smov", "!0r, !1v.H[0]", kFixupNone),
    ENCODING_MAP(kA64SimdSmovXB0, NO_VARIANTS(0x4e012c00),
                 kFmtRegX, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "smov", "!0x, !1v.B[0]", kFixupNone),
    ENCODING_MAP(kA64SimdSmovXH0, NO_VARIANTS(0x4e022c00),
                 kFmtRegX, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "smov", "!0x, !1v.H[0]", kFixupNone),
    ENCODING_MAP(kA64SimdSmovXS0, NO_VARIANTS(0x4e042c00),
                 kFmtRegX, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "smov", "!0x, !1v.S[0]", kFixupNone),
    ENCODING_MAP(kA64SimdUmovWB0, NO_VARIANTS(0x0e013c00),
                 kFmtRegR, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "umov", "!0r, !1v.B[0]", kFixupNone),
    ENCODING_MAP(kA64SimdUmovWH0, NO_VARIANTS(0x0e023c00),
                 kFmtRegR, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE1,
                 "umov", "!0r, !1v.H[0]", kFixupNone),
    ENCODING_MAP(kA64SimdVextQQQI, NO_VARIANTS(0x6e000000),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtBitBlt, 14, 11,
                 IS_QUAD_OP | REG_DEF0_USE12,
                 "ext", "!0v.16b, !1v.16b, !2v.16b, !3d", kFixupNone),
    ENCODING_MAP(kA64SimdVextDDDI, NO_VARIANTS(0x2e000000),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtBitBlt, 14, 11,
                 IS_QUAD_OP | REG_DEF0_USE12,
                 "ext", "!0v.8b, !1v.8b, !2v.8b, !3d", kFixupNone),
    ENCODING_MAP(kA64SimdAdd64QQQ, NO_VARIANTS(0x4ee08400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "add", "!0v.2d, !1v.2d, !2v.2d", kFixupNone),
    ENCODING_MAP(kA64SimdAdd32QQQ, NO_VARIANTS(0x4ea08400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "add", "!0v.4s, !1v.4s, !2v.4s", kFixupNone),
    ENCODING_MAP(kA64SimdAdd16QQQ, NO_VARIANTS(0x4e608400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "add", "!0v.8h, !1v.8h, !2v.8h", kFixupNone),
    ENCODING_MAP(kA64SimdAdd8QQQ, NO_VARIANTS(0x4e208400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "add", "!0v.16b, !1v.16b, !2v.16b", kFixupNone),
    ENCODING_MAP(kA64SimdAdd32DDD, NO_VARIANTS(0x0ea08400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "add", "!0v.2s, !1v.2s, !2v.2s", kFixupNone),
    ENCODING_MAP(kA64SimdAdd16DDD, NO_VARIANTS(0x0e608400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "add", "!0v.4h, !1v.4h, !2v.4h", kFixupNone),
    ENCODING_MAP(kA64SimdAdd8DDD, NO_VARIANTS(0x0e208400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "add", "!0v.8b, !1v.8b, !2v.8b", kFixupNone),
    ENCODING_MAP(kA64SimdFAdd64QQQ, NO_VARIANTS(0x4e60d400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "fadd", "!0v.2d, !1v.2d, !2v.2d", kFixupNone),
    ENCODING_MAP(kA64SimdFAdd32QQQ, NO_VARIANTS(0x4e20d400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "fadd", "!0v.4s, !1v.4s, !2v.4s", kFixupNone),
    ENCODING_MAP(kA64SimdFAdd32DDD, NO_VARIANTS(0x0e20d400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "fadd", "!0v.2s, !1v.2s, !2v.2s", kFixupNone),
    ENCODING_MAP(kA64SimdSaddlp2D4S, NO_VARIANTS(0x4ea02800),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "saddlp", "!0v.2d, !1v.4s", kFixupNone),
    ENCODING_MAP(kA64SimdSaddlp4S8H, NO_VARIANTS(0x4e602800),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "saddlp", "!0v.4s, !1v.8h", kFixupNone),
    ENCODING_MAP(kA64SimdSaddlp8H16B, NO_VARIANTS(0x4e202800),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "saddlp", "!0v.8h, !1v.16b", kFixupNone),
    ENCODING_MAP(kA64SimdSaddlp1D2S, NO_VARIANTS(0x0ea02800),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "saddlp", "!0v.1d, !1v.2s", kFixupNone),
    ENCODING_MAP(kA64SimdSaddlp2S4H, NO_VARIANTS(0x0e602800),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "saddlp", "!0v.2s, !1v.4h", kFixupNone),
    ENCODING_MAP(kA64SimdSaddlp4H8B, NO_VARIANTS(0x0e202800),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "saddlp", "!0v.4h, !1v.8b", kFixupNone),
    ENCODING_MAP(kA64SimdAddp64QQQ, NO_VARIANTS(0x4ee0bc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "addp", "!0v.2d, !1v.2d, !2v.2d", kFixupNone),
    ENCODING_MAP(kA64SimdAddp32QQQ, NO_VARIANTS(0x4ea0bc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "addp", "!0v.4s, !1v.4s, !2v.4s", kFixupNone),
    ENCODING_MAP(kA64SimdAddp16QQQ, NO_VARIANTS(0x4e60bc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "addp", "!0v.8h, !1v.8h, !2v.8h", kFixupNone),
    ENCODING_MAP(kA64SimdAddp8QQQ, NO_VARIANTS(0x4e20bc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "addp", "!0v.16b, !1v.16b, !2v.16b", kFixupNone),
    ENCODING_MAP(kA64SimdAddp32DDD, NO_VARIANTS(0x0ea0bc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "addp", "!0v.2s, !1v.2s, !2v.2s", kFixupNone),
    ENCODING_MAP(kA64SimdAddp16DDD, NO_VARIANTS(0x0e60bc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "addp", "!0v.4h, !1v.4h, !2v.4h", kFixupNone),
    ENCODING_MAP(kA64SimdAddp8DDD, NO_VARIANTS(0x0e20bc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "addp", "!0v.8b, !1v.8b, !2v.8b", kFixupNone),
    ENCODING_MAP(kA64SimdFaddp64QQQ, NO_VARIANTS(0x6e60d400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "faddp", "!0v.2d, !1v.2d, !2v.2d", kFixupNone),
    ENCODING_MAP(kA64SimdFaddp32QQQ, NO_VARIANTS(0x6e20d400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "faddp", "!0v.4s, !1v.4s, !2v.4s", kFixupNone),
    ENCODING_MAP(kA64SimdFaddp32DDD, NO_VARIANTS(0x2e20d400),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "faddp", "!0v.2s, !1v.2s, !2v.2s", kFixupNone),
    ENCODING_MAP(kA64SimdMul32QQQ, NO_VARIANTS(0x4ea09c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "mul", "!0v.4s, !1v.4s, !2v.4s", kFixupNone),
    ENCODING_MAP(kA64SimdMul16QQQ, NO_VARIANTS(0x4e609c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "mul", "!0v.8h, !1v.8h, !2v.8h", kFixupNone),
    ENCODING_MAP(kA64SimdMul8QQQ, NO_VARIANTS(0x4e209c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "mul", "!0v.16b, !1v.16b, !2v.16b", kFixupNone),
    ENCODING_MAP(kA64SimdMul32DDD, NO_VARIANTS(0x0ea09c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "mul", "!0v.2s, !1v.2s, !2v.2s", kFixupNone),
    ENCODING_MAP(kA64SimdMul16DDD, NO_VARIANTS(0x0e609c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "mul", "!0v.4h, !1v.4h, !2v.4h", kFixupNone),
    ENCODING_MAP(kA64SimdMul8DDD, NO_VARIANTS(0x0e209c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "mul", "!0v.8b, !1v.8b, !2v.8b", kFixupNone),
    ENCODING_MAP(kA64SimdFMul64QQQ, NO_VARIANTS(0x6e60dc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "fmul", "!0v.2d, !1v.2d, !2v.2d", kFixupNone),
    ENCODING_MAP(kA64SimdFMul32QQQ, NO_VARIANTS(0x6e20dc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "fmul", "!0v.4s, !1v.4s, !2v.4s", kFixupNone),
    ENCODING_MAP(kA64SimdFMul32DDD, NO_VARIANTS(0x2e20dc00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE12,
                 "fmul", "!0v.2s, !1v.2s, !2v.2s", kFixupNone),
    ENCODING_MAP(kA64SimdVandQQQ, NO_VARIANTS(0x4e201c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP | REG_DEF0_USE12,
                 "and", "!0v.16b, !1v.16b, !2v.16b", kFixupNone),
    ENCODING_MAP(kA64SimdVandDDD, NO_VARIANTS(0x0e201c00),
                 kFmtSimdSd, 4, 0, kFmtSimdSn, 9, 5, kFmtSimdSm, 20, 16,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP | REG_DEF0_USE12,
                 "and", "!0v.8b, !1v.8b, !2v.8b", kFixupNone),
#endif
};
      ...
      for (int i = 0; i < 4; i++) {
        ...
        if (LIKELY(static_cast<unsigned>(kind) <= kFmtBitBlt)) {
          ...
          switch (kind) {
            ...
            case kFmtSimdI8M: {
              uint8_t cmode = 0;
              if ((operand > 0xFFFF && operand < 0x1000000) &&
                  ((operand & 0xFFFF) == 0xFFFF)) {
                cmode = 0b1101;
                operand >>= 16;
              }
              else if ((operand > 0xFF && operand < 0x10000) &&
                       ((operand & 0xFF) == 0xFF)) {
                cmode = 0b1100;
                operand >>= 8;
              } else if ((operand > 0xFFFFFF) && ((operand & 0xFFFFFF) == 0)) {
                cmode = 0b110;
                operand >>= 24;
              } else if ((operand > 0xFFFF) && ((operand & 0xFFFF) == 0)) {
                cmode = 0b100;
                operand >>= 16;
              } else if ((operand > 0xFF) && ((operand & 0xFF) == 0)) {
                cmode = 0b10;
                operand >>= 8;
              }
              value = (cmode & 0xF) << 12;
              value |= ((operand & 0xe0) >> 5) << 16;
              value |= (operand & 0x1f) << 5;
              bits |= value;
            }
              break;
#endif
