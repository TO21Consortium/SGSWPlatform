 ...
 *     X -> quad register name
 *     Y -> dx[0] : low 32-bit field of double reg
 *     y -> dx[1] : high 32-bit field of double reg
 *
...
const ArmEncodingMap ArmMir2Lir::EncodingMap[kArmLast] = {
    ...
    ENCODING_MAP(kThumb2SimdVdup32QR, 0xeea00b10,
                 kFmtSimdQn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vdup.32", "!0X, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVdup16QR, 0xeea00b30,
                 kFmtSimdQn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vdup.16", "!0X, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVdup8QR, 0xeee00b10,
                 kFmtSimdQn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vdup.8", "!0X, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVdup32DR, 0xee800b10,
                 kFmtSimdDn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vdup.32", "!0S, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVdup16DR, 0xee800b30,
                 kFmtSimdDn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vdup.16", "!0S, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVdup8DR, 0xeec00b10,
                 kFmtSimdDn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vdup.8", "!0S, !1C", 4, kFixupNone),

    ENCODING_MAP(kThumb2SimdVdup32QD0, 0xffb40c40,
                 kFmtSimdQd, -1, -1, kFmtSimdDm, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vdup.32", "!0X, !1Y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVdup32QD1, 0xffbc0c40,
                 kFmtSimdQd, -1, -1, kFmtSimdDm, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vdup.32", "!0X, !1y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov64QI, 0xef800e70,
                 kFmtSimdQd, -1, -1, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.i64", "!0X, !1d", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov32QI, 0xef800050,
                 kFmtSimdQd, -1, -1, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.i32", "!0X, !1d", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov16QI, 0xef800850,
                 kFmtSimdQd, -1, -1, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.i16", "!0X, !1d", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov8QI, 0xef800e50,
                 kFmtSimdQd, -1, -1, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.i8", "!0X, !1d", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov32DI, 0xef800010,
                 kFmtSimdDd, -1, -1, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.i32", "!0S, !1d", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov16DI, 0xef800810,
                 kFmtSimdDd, -1, -1, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.i16", "!0S, !1d", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov8DI, 0xef800e10,
                 kFmtSimdDd, -1, -1, kFmtSimdI8M, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.i8", "!0S, !1d", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovF64DI, 0xeeb00b00,
                 kFmtDfp, 22, 12, kFmtFPImm, 16, 0, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP,
                 "vmov.f64", "!0S, #0x!1h", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovF32SI, 0xeeb00a00,
                 kFmtSfp, 22, 12, kFmtFPImm, 16, 0, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP,
                 "vmov.f32", "!0s, #0x!1h", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovQQ, 0xef200150,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmov", "!0X, !1X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovDD, 0xef200110,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmov", "!0S, !1S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovF64DD, 0xeeb00b40,
                 kFmtSimdDd, -1, -1, kFmtSimdDm, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.f64", "!0S, !1S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovF32SS, 0xeeb00a40,
                 kFmtSfp, 22, 12, kFmtSfp, 5, 0, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.f32", "!0s, !1s", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov32D0R, 0xee000b10,
                 kFmtSimdDn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.32", "!0Y, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov32D1R, 0xee200b10,
                 kFmtSimdDn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.32", "!0y, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov16D0R, 0xee000b30,
                 kFmtSimdDn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.16", "!0Y, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov16D1R, 0xee000b70,
                 kFmtSimdDn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.16", "!0y, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov8D0R, 0xee400b10,
                 kFmtSimdDn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.8", "!0Y, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov8D1R, 0xee400b30,
                 kFmtSimdDn, -1, -1, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.8", "!0y, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov32RD0, 0xee100b10,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.32", "!0C, !1Y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmov32RD1, 0xee300b10,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.32", "!0C, !1y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovS16RD0, 0xee100b30,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.s16", "!0C, !1Y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovS16RD1, 0xee100b70,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.s16", "!0C, !1y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovS8RD0, 0xee500b10,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.s8", "!0C, !1Y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovS8RD1, 0xee500b30,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.s8", "!0C, !1y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovU16RD0, 0xee900b30,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.u16", "!0C, !1Y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovU16RD1, 0xee900b70,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.u16", "!0C, !1y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovU8RD0, 0xeed00b10,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.u8", "!0C, !1Y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovU8RD1, 0xeed00b30,
                 kFmtBitBlt, 15, 12, kFmtSimdDn, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov.u8", "!0C, !1y", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovSR, 0xee000a10,
                 kFmtSfp, 7, 16, kFmtBitBlt, 15, 12, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov", "!0s, !1C", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmovRS, 0xee100a10,
                 kFmtBitBlt, 15, 12, kFmtSfp, 7, 16, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vmov", "!0C, !1s", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVextQQQI, 0xefb00040,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtBitBlt, 11, 8,
                 IS_QUAD_OP,
                 "vext.8", "!0X, !1X, !2X, !3d", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVextDDDI, 0xefb00000,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtBitBlt, 11, 8,
                 IS_QUAD_OP,
                 "vext.8", "!0S, !1S, !2S, !3d", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVaddS32QQQ, 0xef200840,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vadd.s32", "!0X, !1X, !2X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVaddS16QQQ, 0xef100840,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vadd.s16", "!0X, !1X, !2X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVaddS8QQQ, 0xef000840,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vadd.s8", "!0X, !1X, !2X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVaddS64DDD, 0xef300800,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vadd.s64", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVaddS32DDD, 0xef200800,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vadd.s32", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVaddS16DDD, 0xef100800,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vadd.s16", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVaddS8DDD, 0xef000800,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vadd.s8", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVaddF32QQQ, 0xef000d40,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vadd.f32", "!0X, !1X, !2X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVaddF32DDD, 0xef000d00,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vadd.f32", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddI32DDD, 0xef200b10,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vpadd.i32", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddI16DDD, 0xef100b10,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vpadd.i16", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddI8DDD, 0xef000b10,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vpadd.i8", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddF32DDD, 0xff000d00,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vpadd.f32", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddl32QQ, 0xffb80240,
                 kFmtSimdQd, -1, -1, kFmtSimdQm, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vpaddl.s32", "!0X, !1X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddl16QQ, 0xffb40240,
                 kFmtSimdQd, -1, -1, kFmtSimdQm, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vpaddl.s16", "!0X, !1X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddl8QQ, 0xffb00240,
                 kFmtSimdQd, -1, -1, kFmtSimdQm, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vpaddl.s8", "!0X, !1X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddl32DD, 0xffb80200,
                 kFmtSimdDd, -1, -1, kFmtSimdDm, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vpaddl.s32", "!0S, !1S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddl16DD, 0xffb40200,
                 kFmtSimdDd, -1, -1, kFmtSimdDm, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vpaddl.s16", "!0S, !1S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVpaddl8DD, 0xffb00200,
                 kFmtSimdDd, -1, -1, kFmtSimdDm, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP,
                 "vpaddl.s8", "!0S, !1S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmulS32QQQ, 0xef200950,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmul.s32", "!0X, !1X, !2X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmulS16QQQ, 0xef100950,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmul.s16", "!0X, !1X, !2X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmulS8QQQ, 0xef000950,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmul.s8", "!0X, !1X, !2X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmulS32DDD, 0xef200910,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmul.s32", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmulS16DDD, 0xef100910,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmul.s16", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmulS8DDD, 0xef000910,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmul.s8", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmullS32QDD, 0xefa00c00,
                 kFmtSimdQd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmull.s32", "!0X, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmullS16QDD, 0xef900c00,
                 kFmtSimdQd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmull.s16", "!0X, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmullS8QDD, 0xef800c00,
                 kFmtSimdQd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmull.s8", "!0X, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmulF32QQQ, 0xff000d50,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmul.f32", "!0X, !1X, !2X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVmulF32DDD, 0xff000d10,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vmul.f32", "!0S, !1S, !2S", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVandQQQ, 0xef000150,
                 kFmtSimdQd, -1, -1, kFmtSimdQn, -1, -1, kFmtSimdQm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vand", "!0X, !1X, !2X", 4, kFixupNone),
    ENCODING_MAP(kThumb2SimdVandDDD, 0xef000110,
                 kFmtSimdDd, -1, -1, kFmtSimdDn, -1, -1, kFmtSimdDm, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP,
                 "vand", "!0S, !1S, !2S", 4, kFixupNone),
#endif
};
        ...
        for (int i = 0; i < 4; i++) {
          ...
          if (LIKELY(kind == kFmtBitBlt)) {
...
#ifdef EXYNOS_ART_OPT
            case kFmtSimdQd:
              value = ((operand & 0x8) >> 3) << 22;
              value |= (operand & 0x7) << 13;
              bits |= value;
              break;
            case kFmtSimdQn:
              value = ((operand & 0x8) >> 3) << 7;
              value |= (operand & 0x7) << 17;
              bits |= value;
              break;
            case kFmtSimdQm:
              value = ((operand & 0x8) >> 3) << 5;
              value |= (operand & 0x7) << 1;
              bits |= value;
              break;
            case kFmtSimdDd:
              value = ((operand & 0x10) >> 4) << 22;
              value |= (operand & 0xf) << 12;
              bits |= value;
              break;
            case kFmtSimdDn:
              value = ((operand & 0x10) >> 4) << 7;
              value |= (operand & 0xf) << 16;
              bits |= value;
              break;
            case kFmtSimdDm:
              value = ((operand & 0x10) >> 4) << 5;
              value |= operand & 0xf;
              bits |= value;
              break;
            case kFmtSimdSd:
            ...
            case kFmtSimdI8M: {
              ...
              value = (cmode & 0xF) << 8;
              value |= ((operand & 0x80) >> 7) << 28;
              value |= ((operand & 0x70) >> 4) << 16;
              value |= operand & 0xf;
              bits |= value;
            }
              break;
