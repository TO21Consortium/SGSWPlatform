...
enum ArmNativeRegisterPool {  // private marker to avoid generate-operator-out.py from processing.
  ...
  // quadword registers, quad precision aliases
...
enum ArmOpcode {
 ...
 // EXYNOS_ART_OPT start.
  ...
  kThumb2SimdVdup16DR,
  kThumb2SimdVdup8DR,
  kThumb2SimdVdup32QD0,
  kThumb2SimdVdup32QD1,
  kThumb2SimdVmov64QI,
  kThumb2SimdVmov32QI,
  kThumb2SimdVmov16QI,
  kThumb2SimdVmov8QI,
  ...
  kThumb2SimdVmov16DI,
  kThumb2SimdVmov8DI,
  kThumb2SimdVmovF64DI,
  kThumb2SimdVmovF32SI,
  kThumb2SimdVmovQQ,
  kThumb2SimdVmovDD,
  kThumb2SimdVmovF64DD,
  kThumb2SimdVmovF32SS,
  kThumb2SimdVmov32D0R,
  kThumb2SimdVmov32D1R,
  kThumb2SimdVmov16D0R,
  kThumb2SimdVmov16D1R,
  kThumb2SimdVmov8D0R,
  kThumb2SimdVmov8D1R,
  kThumb2SimdVmov32RD0,
  kThumb2SimdVmov32RD1,
  kThumb2SimdVmovS16RD0,
  kThumb2SimdVmovS16RD1,
  kThumb2SimdVmovS8RD0,
  kThumb2SimdVmovS8RD1,
  kThumb2SimdVmovU16RD0,
  kThumb2SimdVmovU16RD1,
  kThumb2SimdVmovU8RD0,
  kThumb2SimdVmovU8RD1,
  kThumb2SimdVmovSR,
  kThumb2SimdVmovRS,
  kThumb2SimdVextQQQI,
  kThumb2SimdVextDDDI,
  kThumb2SimdVaddS32QQQ,
  kThumb2SimdVaddS16QQQ,
  kThumb2SimdVaddS8QQQ,
  kThumb2SimdVaddS64DDD,
  kThumb2SimdVaddS32DDD,
  kThumb2SimdVaddS16DDD,
  kThumb2SimdVaddS8DDD,
  kThumb2SimdVaddF32QQQ,
  kThumb2SimdVaddF32DDD,
  kThumb2SimdVpaddI32DDD,
  kThumb2SimdVpaddI16DDD,
  kThumb2SimdVpaddI8DDD,
  kThumb2SimdVpaddF32DDD,
  kThumb2SimdVpaddl32QQ,
  kThumb2SimdVpaddl16QQ,
  kThumb2SimdVpaddl8QQ,
  kThumb2SimdVpaddl32DD,
  kThumb2SimdVpaddl16DD,
  kThumb2SimdVpaddl8DD,
  kThumb2SimdVmulS32QQQ,  // VMUL(integer) s32 Qd, Qn, Qm
  kThumb2SimdVmulS16QQQ,  // VMUL(integer) s16 Qd, Qn, Qm
  kThumb2SimdVmulS8QQQ,   // VMUL(integer) s8  Qd, Qn, Qm
  kThumb2SimdVmulS32DDD,  // VMUL(integer) s32 Dd, Dn, Dm
  kThumb2SimdVmulS16DDD,  // VMUL(integer) s16 Dd, Dn, Dm
  kThumb2SimdVmulS8DDD,   // VMUL(integer) s8  Dd, Dn, Dm
  kThumb2SimdVmullS32QDD, // VMULL(integer) s32 Qd, Dn, Dm
  kThumb2SimdVmullS16QDD, // VMULL(integer) s16 Qd, Dn, Dm
  kThumb2SimdVmullS8QDD,  // VMULL(integer) s8  Qd, Dn, Dm
  kThumb2SimdVmulF32QQQ,  // VMUL(floating-point) f32 Qd, Qn, Qm
  kThumb2SimdVmulF32DDD,  // VMUL(floating-point) f32 Dd, Dn, Dm
  kThumb2SimdVandQQQ,
  kThumb2SimdVandDDD,
// EXYNOS_ART_OPT end
  kArmLast,
...
enum ArmEncodingKind {
  ...
  // EXYNOS_ART_OPT start
  kFmtSimdQd,    // SIMD operand, [22, 15..13] [12]=0
  kFmtSimdQn,    // SIMD operand, [7, 19..17] [16]=0
  kFmtSimdQm,    // SIMD operand, [5, 3..1] [0]=0
  kFmtSimdDd,    // SIMD operand, [22, 15..12]
  kFmtSimdDn,    // SIMD operand, [7, 19..16]
  kFmtSimdDm,    // SIMD operand, [5, 3..0]
  kFmtSimdSd,    // SIMD operand, [22, 15..12]
  kFmtSimdSn,    // SIMD operand, [7, 19..16]
  kFmtSimdSm,    // SIMD operand, [5, 3..0]
  kFmtSimdI8M,   // SIMD vmov immedate operand, [28, 18..16, 3..0] cmode : [11-8]
// EXYNOS_ART_OPT end
