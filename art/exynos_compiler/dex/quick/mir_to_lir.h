  ...
  public:
    ...
    class RegisterPool : public DeletableArenaObject<kArenaAllocRegAlloc> {
     public:
      ...
      ArenaVector<RegisterInfo*> xp_regs_;    // Qaudword register
      int next_xp_reg_;
#endif
...
#ifdef EXYNOS_ART_OPT
    virtual void GenBranchToFallthrough(BasicBlock* bb) { UNUSED(bb); };
    virtual void GenRangeCheck(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenBranchToLoop(BasicBlock* bb) { UNUSED(bb); };
    virtual void GenLowerBoundCheck(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir);};
    virtual void ReserveVectorRegisters(MIR* mir) {UNUSED(mir);};
    virtual void ReturnVectorRegisters(MIR* mir)  {UNUSED(mir);};
    virtual void GenVectorBodyEndIndex(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenVectorBodyIndVarInc(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenMidBlkExitCond(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenSIMDAdd(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenSIMDConst(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenSIMDMul(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenSIMDAnd(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenSIMDMove(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenSIMDInitIndVar(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenSIMDInitRdxVar(BasicBlock* bb, MIR* mir) { UNUSED(bb); UNUSED(mir); };
    virtual void GenVectorToScalarForAddRdxOp(BasicBlock* bb, MIR* mir) {
      UNUSED(bb);
      UNUSED(mir);
    };
    virtual void GenVectorToScalarForMulRdxOp(BasicBlock* bb, MIR* mir) {
      UNUSED(bb);
      UNUSED(mir);
    };
