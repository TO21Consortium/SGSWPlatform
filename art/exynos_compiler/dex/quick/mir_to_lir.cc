...
void Mir2Lir::HandleExtendedMethodMIR(BasicBlock* bb, MIR* mir) {
  switch (static_cast<ExtendedMIROpcode>(mir->dalvikInsn.opcode)) {
    ...
    case kMirOpCheck:
      ...
      break;
#ifdef EXYNOS_ART_OPT
    case kMirOpBranchToLoop:
      GenBranchToFallthrough(bb);
      break;
    case kMirOpBranchToPostExit:
      GenBranchToFallthrough(bb);
      break;
    case kMirOpLowerBoundCheck:
      GenLowerBoundCheck(bb, mir);
      break;
    ...
    case kMirOpReturnVectorRegisters:
      ...
      break;
    case kMirOpLoopVectorizerVectorBodyEndIndex:
      GenVectorBodyEndIndex(bb, mir);
      break;
    case kMirOpLoopVectorizerVectorBodyIndVarInc:
      GenVectorBodyIndVarInc(bb, mir);
      break;
    case kMirOpLoopVectorizerMidBlkExitCond:
      GenMidBlkExitCond(bb, mir);
      break;
    case kMirOpSimdInitIndVar:
      GenSIMDInitIndVar(bb, mir);
      break;
    case kMirOpSimdInitRdxVar:
      GenSIMDInitRdxVar(bb, mir);
      break;
    case kMirOpVectorToScalarForAddRdxOp:
      GenVectorToScalarForAddRdxOp(bb, mir);
      break;
    case kMirOpVectorToScalarForMulRdxOp:
      GenVectorToScalarForMulRdxOp(bb, mir);
      break;
#endif
    default:
