...
enum LIRPseudoOpcode {
  kPseudoLoopEntryVeneerLabel = -22,
  kPseudoLoopExitVeneerLabel = -21,
  kPseudoLoopEndBlockLabel = -20,
  kPseudoLoopHeadBlockLabel = -19,
...
enum ExtendedMIROpcode {
  ...
  kMirOpBranchToPostExit,

  kMirOpLowerBoundCheck,

  kMirOpLoopVectorizerVectorBodyEndIndex,
  kMirOpLoopVectorizerVectorBodyIndVarInc,
  kMirOpLoopVectorizerMidBlkExitCond,
  kMirOpSimdInitIndVar,
  kMirOpSimdInitRdxVar,
  kMirOpVectorToScalarForAddRdxOp,
  kMirOpVectorToScalarForMulRdxOp,
  kMirOpLast,
};
#else
enum ExtendedMIROpcode {
