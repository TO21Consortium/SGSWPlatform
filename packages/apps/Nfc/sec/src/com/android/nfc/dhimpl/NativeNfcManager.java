 ...
 * limitations under the LDeviceHost.routeAidicense.
 */
...
/* START [16052901J] - Change listen tech mask values */
    @Override
    public native void doChangeListenTechMask(int tech_mask);
...
/* START [J15041301] - Support SE on Device Power Off State */
    @Override
    public native void doSetScreenOrPowerState(int state);
/* END [J15041301] - Support SE on Device Power Off State */
