...
#define LOG_TAG "SMDK7270PowerHAL"
#include <utils/Log.h>

#include <hardware/hardware.h>
#include <hardware/power.h>

struct smdk7270_power_module {
...
{
    struct smdk7270_power_module *smdk7270 = (struct smdk7270_power_module *) module;
...
static void smdk7270_power_hint(struct power_module *module, power_hint_t hint,
                             void *data)
{
    struct smdk7270_power_module *smdk7270 = (struct smdk7270_power_module *) module;
    char buf[80];
...
struct smdk7270_power_module HAL_MODULE_INFO_SYM = {
    base: {
        common: {
