...
#ifdef OSI_DEBUG
//#define __osi_log(type, ...)    (void)SLOG(type, "SecHAL", __VA_ARGS__)
#define OSI_logt(format, ...)   do{if (osi_debug_level >= 2) SLOGI("%s: " format, __func__, ##__VA_ARGS__);} while(0)
#define OSI_logd(format, ...)   do{if (osi_debug_level >= 1) SLOGD("%s: " format, __func__, ##__VA_ARGS__);} while(0)
#define OSI_loge(format, ...)   do{if (osi_debug_level >= 0) SLOGE("%s: " format, __func__, ##__VA_ARGS__);} while(0)
#else
#define OSI_logt(...)
#define OSI_logd(...)
#define OSI_loge(...)
